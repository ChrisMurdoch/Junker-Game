...
public class LarryHookProjectile : MonoBehaviour
{
    private Rigidbody rb;
    private GameObject Player;

    [HideInInspector] public LarryHookLauncher launcher;
    ...
    void Start()
    {
        ...
        Player = FindObjectOfType<LarryPlayerController>().gameObject;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.CompareTag("Environment"))
        {
            ...
            Player.GetComponent<LarryPlayerController>().ChangeState(1);
