...
public class LarryHookLauncher : MonoBehaviour
{
    ...
    [HideInInspector] public LarryHookProjectile LarryhookProjectileScript;
    ...
    public void FireHook()
    {
        if (FiredHook == null)
        {
            ...
            LarryhookProjectileScript = FiredHook.GetComponent<LarryHookProjectile>();
            LarryhookProjectileScript.launcher = GetComponent<LarryHookLauncher>();
            LarryhookProjectileScript.SetHookParameters(hookSpeed, returnSpeed, maxLength);
